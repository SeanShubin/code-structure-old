...
data class ProcessOutput(
    ...
    private fun composeOutputLines(): List<String> = listOf("outputLines (${outputLines.size})") + outputLines.map{"  $it"}
    private fun composeErrorLines(): List<String> = listOf("errorLines (${errorLines.size})") + errorLines.map{"  $it"}
}
